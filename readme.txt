...
1. Download the plugin from this page- https://wordpress.org/plugins/scrolling-notice-board/
	 Now, Go to Plugins >> Add New >> Upload and select your recently downloaded plugin package "scrolling-notice-board-v1.1.x.xx.zip". Now click "Install Now". After the successful installation, click on "Activate Plugin" to activate the plugin. Now go to Appearance >> Widgets and find the widget "Scrolling Notice Board". Drag the widget to your preferred sidebar position and you're done.

1. Extract the plugin file and upload the folder named "scrolling-notice-board" into your "/wp-content/plugins" location of your WordPress installation. Now login to your WordPress admin panel and go to Plugins >> Installed Plugins and Activate the recently added "Scrolling Notice Board". Now go to Appearance >> Widgets and find the widget "Scrolling Notice Board". Drag the widget to your preferred sidebar position and you're done.

1. Directly from WordPress plugin repository: Go to Plugins >> Add New and search for Scrolling Notice Board. Now click Install to install it directly from the official WordPress plugin repository. After the successful installation, click on "Activate Plugin" to activate the plugin. Now go to Appearance >> Widgets and find the widget "Scrolling Notice Board". Drag the widget to your preferred sidebar position and you're done.


== Screenshots ==
Screenshots can be found in this URL - http://www.freestylepost.com/scrolling-notice-board/


== Demo ==
Live demo can be found in this URL- http://www.freestylepost.com/scrolling-notice-board/
...
* v.1.1.5.03 - 30-Dec-2014

* v1.1.5.02 - 16-Dec-2014

* v1.1.5.01 - 15-Dec-2014
...
== Changelog ==
v1.2.1 - 19-Sep-2015 - Plugin Tested up to WordPress v4.3.1

v1.2.0 - 27-Aug-2015 - Style Updated.

v1.1.11 - 27-Aug-2015 - Bug fixes, Plugin tested upto WordPress v4.3

v1.1.10 - 30-Jun-2015 - Bug fixes.

v1.1.9 - 16-May-2015 - Plugin tested upto WordPress v4.2.2

v1.1.8 - 13-Apr-2015 - Plugin tested upto WordPress v4.1.1

v1.1.7 - 13-Apr-2015 - Bug fixes.

v1.1.6 - 01-Jan-2015 - Plugin tested upto WordPress v4.1

v1.1.5.03 - 30-Dec-2014 - Appearance modified. Bug fixes.

v1.1.5.02 - 16-Dec-2014 - Bug fixes.

v1.1.5.01 - 15-Dec-2014 - Change in the widget style.

v1.1.5 - 15-Dec-2014 - License file added.
